...
const ProductOrderStep = ({
  data,
  onUpdate,
  onNext,
  onPrev
}: ProductOrderStepProps) => {
  ...
  return <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="space-y-8">
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-gray-600 mb-2">2-ply, 40cm x 40cm, 1200 Napkins Per Carton</p>
            ...
            <div>
              ...
              <RadioGroup value={data.dinnerNapkins.quantity} onValueChange={value => handleProductUpdate('dinnerNapkins', 'quantity', value)} className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {['100', '250', '500', '1000', '1500+', 'other'].map(option => <div key={option} className="flex items-center space-x-2 border rounded-lg p-3 hover:bg-gray-50">
              ...
              {data.dinnerNapkins.quantity === 'other' && <Input placeholder="Enter custom amount" value={data.dinnerNapkins.customAmount} onChange={e => handleProductUpdate('dinnerNapkins', 'customAmount', e.target.value)} className="mt-3 max-w-xs" />}
            </div>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div>
              ...
              <RadioGroup value={data.kitchenRolls.quantity} onValueChange={value => handleProductUpdate('kitchenRolls', 'quantity', value)} className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {['100', '500', '1000', '3000', '5000+', 'other'].map(option => <div key={option} className="flex items-center space-x-2 border rounded-lg p-3 hover:bg-gray-50">
              ...
              {data.kitchenRolls.quantity === 'other' && <Input placeholder="Enter custom amount" value={data.kitchenRolls.customAmount} onChange={e => handleProductUpdate('kitchenRolls', 'customAmount', e.target.value)} className="mt-3 max-w-xs" />}
            </div>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            ...
            <div>
              ...
              <RadioGroup value={data.compressedTowels.quantity} onValueChange={value => handleProductUpdate('compressedTowels', 'quantity', value)} className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {['10,000', '50,000', '100,000', '120,000', '250,000+', 'other'].map(option => <div key={option} className="flex items-center space-x-2 border rounded-lg p-3 hover:bg-gray-50">
              ...
              {data.compressedTowels.quantity === 'other' && <Input placeholder="Enter custom amount" value={data.compressedTowels.customAmount} onChange={e => handleProductUpdate('compressedTowels', 'customAmount', e.target.value)} className="mt-3 max-w-xs" />}
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between mt-8">
          ...
          <Button onClick={onNext} disabled={!hasAnySelection()} className="bg-orange-600 hover:bg-orange-700 flex items-center gap-2">
            Continue
