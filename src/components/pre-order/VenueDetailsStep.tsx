      ...
      <div className="rounded-xl shadow-lg p-8 bg-white">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Input id="location" value={data.location} onChange={e => handleInputChange('location', e.target.value)} placeholder="e.g., Melbourne CBD, Sydney, Brisbane" className="mt-2" />
        ...
        <div className="flex justify-between mt-8">
          ...
          <Button onClick={onNext} disabled={!isFormValid} className="bg-orange-600 hover:bg-orange-700 flex items-center gap-2">
